...
def configure(config):
    ...
    | --------- | ------- | ------- |
    | consumer_key | 09d8c17b0987czzZc7fge09 | OAuth consumer key |
    | consumer_secret | LIaso6873jI8Ydasdlfi76awer76yhashHhdfi75h6TFJgf | OAuth consumer secret |
    | access_token | 564018348-Adlldf7s6598d76tgsadfo9aKKkksdf561uUf65aVgdsf6 | OAuth access token |
    | access_token_secret | as1dfl7698596KIK34JVGvJDcfcvcsfdy85cChfddlku67 | OAuth access token secret |
    """
...
def gettweet(willie, trigger, found_match=None):
    ...
    try:
        ...
        willie.say(twituser + ": " + str(status.text))
    except:
